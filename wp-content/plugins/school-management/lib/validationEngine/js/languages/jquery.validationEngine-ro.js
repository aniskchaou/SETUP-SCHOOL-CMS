        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* Câmpul trebuie să fie egal cu testul"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Perioada ",
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Doar scrisori și ' _,`.'^-' Caractere permise"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Doar scrisori, numere și ' _,`.'^' Caractere permise"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Doar numere și ' -+' Caractere permise"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Acest nume de utilizator - utilizator este deja înregistrat",
