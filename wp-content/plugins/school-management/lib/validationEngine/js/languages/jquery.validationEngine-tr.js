        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* Alan eşit olmalıdır test"
                },
                "minSize": {
                    "regex": "none",
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Sadece harfler Ve ' _,`.'^-' İzin Verilen Karakterler"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Sadece Harfler, Sayılar Ve ' _,`.'^' İzin Verilen Karakterler"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Sadece sayılar ve ' -+' İzin Verilen Karakterler"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Bu kullanıcı adı zaten kayıtlı",
