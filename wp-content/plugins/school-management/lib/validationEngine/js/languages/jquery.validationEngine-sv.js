        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* Fältet måste motsvara testet"
                },
                "minSize": {
                    "regex": "none",
                    "alertText": "* Minimum ",
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Endast bokstäver och ' _,`.'^-' Tecken tillåtna"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Endast bokstäver, siffror och ' _,`.'^' Tecken tillåtna"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Endast siffror och ' -+' Tecken tillåtna"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Detta användarnamn är redan registrerat",
