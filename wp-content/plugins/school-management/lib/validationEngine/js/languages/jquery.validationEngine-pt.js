        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* Campo deve ser igual ao teste"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Inválido ",
			...
			"func": function (field) {
			 ...
			 "alertText": "* Data inválida, o formato deve de ser AAAA-MM-DD (ex.2012-12-31)"
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Apenas letras e ' _,`.'^-' Personagens permitidos"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Apenas letras, Números e ' _,`.'^' Personagens permitidos"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Apenas números e ' -+' Personagens permitidos"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
					"alertText": "* Este usuário - nome de usuário já está registrado",
