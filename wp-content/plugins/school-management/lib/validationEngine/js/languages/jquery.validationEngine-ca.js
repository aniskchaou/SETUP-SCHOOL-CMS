    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				{
                     "regex": /^[a-zA-Z\ \_\,\`\.\'\^\-]+$/,
                    "alertText": "* Només lletres i ' _,`.'^-' caràcters permesos"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\ \_\,\`\.\'\^]+$/,
                    "alertText": "* Només lletres, números i ' _,`.'^' caràcters permesos"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "*  Només números i ' -+' caràcters permesos"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "alertText": "* Aquest usuari: el nom d'usuari ja està registrat"
                },
                "ajaxNameCall": {
