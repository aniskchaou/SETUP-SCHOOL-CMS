        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "requiredInFunction": { 
                    ...
                    "alertText": "* Polje mora biti jednako testu"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Greška ",
				...
				{
                     "regex": /^([^\u0000-\u007F]|[a-zA-Z\ \_\,\`\.\'\^\-])+$/,
                    "alertText": "* Samo slova i ' _,`.'^-' Dopušteni znakovi"
                },
				...
				{
                    "regex": /^([^\u0000-\u007F]|[0-9a-zA-Z\ \_\,\`\.\'\^])+$/,
                    "alertText": "* Samo slova, brojevi i ' _,`.'^' Dopušteni znakovi"
                },
				...
				{
                    "regex": /^[0-9\ \-\+]+$/,
                    "alertText": "* Samo brojevi i ' -+' Dopušteni znakovi"
                }, 
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Ovo je korisničko ime već registrirano",
