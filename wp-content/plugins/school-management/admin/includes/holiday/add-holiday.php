    ...
    <form name="holiday_form" action="" method="post" class="form-horizontal" id="holiday_form">
       <?php $action = isset($_REQUEST['action'])?$_REQUEST['action']:'insert';?>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo date("m/d/Y",strtotime($holiday_data->date)); }?>" name="date" readonly>				
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="end_date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo date("m/d/Y",strtotime($holiday_data->end_date));}?>" name="end_date" readonly>				
			</div>
		</div>
