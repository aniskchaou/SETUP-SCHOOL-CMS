...
<div class="panel-body"> 
    <form method="post" id="subject_attendance">  
        ...
        <div class="form-group col-md-2">
			...
			<input id="curr_date" class="form-control curr_date" type="text" value="<?php if(isset($_POST['curr_date'])) echo $_POST['curr_date']; else echo  date("Y-m-d");?>" name="curr_date" readonly>		
		</div>
		<div class="form-group col-md-2">
