...
<div class="panel-body"> 
	<form method="post">           
        <div class="form-group col-md-3">
			...
			<input id="curr_date" class="form-control" type="text" value="<?php if(isset($_POST['tcurr_date'])) echo $_POST['tcurr_date']; else echo  date("Y-m-d");?>" name="tcurr_date" readonly>			
		</div>
