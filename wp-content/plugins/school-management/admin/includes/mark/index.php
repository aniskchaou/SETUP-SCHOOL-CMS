	...
	<div class="table-responsive">
		...
		<?php
			...
			foreach ( $student as $user ) {
				...
				echo '<td>';
				echo '<input type="text" name="marks_'.$user->ID.'" value="'.(isset($key)? $csv[$key]['marks'] : $marks).'" class="form-control validate[required,custom[onlyNumberSp]] text-input">';
				echo '</td>';
				
				echo '<td>';
				echo '<input type="text" name="comment_'.$user->ID.'" value="'.(isset($key)? $csv[$key]['comment'] : $marks_comment).'" class="form-control">';
				echo '</td>';
				echo '<td>';
