							...
							<tr>
								...
								<?php  
									...
									{?>
										...
										{?>
											<td><?php echo $retrieved_data->uploaded_date;?></td>
											<?php 
										}?>
										...
										if($retrieved_data->status==1)
										{ ?>
											<td><a href="?page=smgt_student_homewrok&tab=view_stud_detail&action=download&stud_homework_id=<?php echo $retrieved_data->stu_homework_id;?>" class="btn btn-info"> <?php _e('Download','school-mgt');?></a>
