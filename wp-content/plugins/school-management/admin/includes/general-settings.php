...
<h2>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="smgt_staring_year" class="form-control validate[minSize[4],maxSize[4]]" type="number" value="<?php echo get_option( 'smgt_staring_year' );?>"  name="smgt_staring_year">
			</div>
		</div>
		<div class="form-group">
