...
<form name="class_form" action="" method="post" class="form-horizontal" id="notification_form">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				 ...
				 <select name="class_id"  id="notification_class_list_id" class="form-control">
			...
			<div class="col-sm-8">
                        <select name="class_section" class="form-control" id="notification_class_section_id">
                        	<option value="All"><?php _e('All','school-mgt');?></option>
                        </select>
			</div>
		</div>
		<div class="form-group">
			...
			<span class="notification_user_display_block">
				<select name="selected_users" id="notification_selected_users" class="form-control">
				<option value="All"><?php _e('All','school-mgt');?></option>				
					<?php 
