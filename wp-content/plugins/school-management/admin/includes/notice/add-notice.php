...
?>
	...
	<form name="class_form" action="" method="post" class="form-horizontal" id="notice_form">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
			<input id="notice_Start_date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo date("m/d/Y",strtotime(get_post_meta($post->ID,'start_date',true)));}?>" name="start_date" readonly>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
			<input id="notice_end_date" class="datepicker form-control validate[required] text-input" type="text" value="<?php if($edit){ echo date("m/d/Y",strtotime(get_post_meta($post->ID,'end_date',true)));}?>" name="end_date" readonly>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label " for="enable"><?php _e('Send SMS And Mail','school-mgt');?></label>
			<div class="col-sm-8">
				 <div class="checkbox">
				 	<label>
