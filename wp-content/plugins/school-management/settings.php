...
if ( is_admin() )
{
	...
	function smgt_option(){
		$options=array(
			...
			"smgt_student_list_access"	=>"own_class",
			"smgt_teacher_show_access"=>"own_class",
			"smgt_teacher_list_access" => "own",
...
Regards From {{school_name}}.",
		...
		"add_user_mail_subject" => 'Your have been assigned {{role}} of Role Name in {{school_name}}.',
		"add_user_mail_content"=>"Dear {{user_name}},

         You are Added by admin in {{school_name}} . Your have been assigned role of {{role}} in {{school_name}}.  You can signin using this link. {{login_link}}
...
Regards From {{school_name}}
',
'homework_mailcontent'	=>	'Dear {{parent_name}} New homework has been assign to you/your child
...
'stu_homework_mailcontent'	=>	'Dear {{student_name}} New homework has been assign to you
Homework Title : {{title}}
Submission Date : {{submition_date}}
...
'
	...
	{
		$page_array = array('smgt_school','smgt_setup','smgt_student','smgt_student_homewrok','smgt_teacher','smgt_parent','smgt_Subject','smgt_class','smgt_route','smgt_attendence','smgt_exam',
				...
				'smgt_Migration','smgt_sms-setting','smgt_gnrl_settings','smgt_supportstaff','smgt_library','smgt_access_right','smgt_view-attendance','smgt_email_template','smgt_show_infographic','smgt_notification');
		return  $page_array;
	}
function smgt_change_adminbar_css() {
	...
	if (is_rtl())
	{
	    ...
	    wp_enqueue_script('smgt-validationEngine-en-js', plugins_url( '/assets/js/jquery.validationEngine-en.js', __FILE__ ) );
	}
