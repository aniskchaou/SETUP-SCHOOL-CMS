...
?>
	<div id="message" class="updated below-h2"><p><?php _e('Attendance successfully saved!','school-mgt');?></p></div>
<?php 
}
...
$(document).ready(function() {
	...
	$('#curr_date').datepicker({maxDate:'0',dateFormat: "yy-mm-dd"});
} );
</script>
    ...
    <div class="panel-body">
		<form method="post" id="student_attendance">  
			...
			<div class="form-group col-md-3 col-xs-12 col-sm-3">
                <label for="exampleInputEmail1"><?php _e('Date','school-mgt');?></label>				   
				<input id="curr_date" type="text" name="curr_date" value="<?php if(isset($_POST['curr_date'])) echo smgt_getdate_in_input_box($_POST['curr_date']); else echo  date("Y-m-d");?>"  class="form-control" readonly />                        
            </div>
            <div class="form-group col-md-3 col-xs-12 col-sm-3">
    ...
    <form method="post" id="subject_attendance">  
        ...
        <div class="form-group col-md-2">
			<label class="control-label" for="curr_date"><?php _e('Date','school-mgt');?></label>
				<input id="curr_date" class="form-control" type="text" value="<?php if(isset($_POST['curr_date'])) echo smgt_getdate_in_input_box($_POST['curr_date']); else echo  date("Y-m-d");?>" name="curr_date" readonly>			
		</div>
		<?php
			if(get_option('smgt_attendance_access')=='own_subject')
			{	?> 
