 ...
 <ul class="nav nav-tabs" role="tablist">
    ...
    <div class="tab-content">
      <div class="tab-pane fade active in" id="examlist">
          <h2>
        	<?php echo esc_html( __( 'Subject list', 'school-mgt' ) );?>
        </h2>
      ...
      <div class="tab-pane fade" id="add_subject">
			...
			if(isset($_POST['subject']))
			{
				...
				{
					//$sullabus=$_POST['subject_syllabus'];
				...
				$subjects=array('sub_name'=>MJ_smgt_popup_category_validation($_POST['subject_name']),
								'class_id'=>MJ_smgt_onlyNumberSp_validation($_POST['subject_class']),
								'teacher_id'=>MJ_smgt_onlyNumberSp_validation($_POST['subject_teacher']),
				...
				<input type="hidden" name="action" value="<?php echo $action;?>">
					<table class="form-table">	
							<tr class="user-user-login-wrap">
								<th >
									<label><?php _e('Subject Name','school-mgt');?> </label></th>
								<td>
							...
							<tr class="user-user-login-wrap">
								<th >
									<label><?php _e('Class','school-mgt');?>  </label></th>
								<td>
							...
							<tr class="user-user-login-wrap">
								<th >
									<label><?php _e('Teacher','school-mgt');?>  </label></th>
								<td>
